<html lang="en"><head>
    ...
    <!-- Favicon -->
    <link href="{{ asset('wolfs') }}/public/storage" rel="icon" type="image/png">
    <!-- Fonts -->
        ...
        <li class="nav-item dropdown">
            <a class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="media align-items-center">
                    ...
                    <img alt="Image placeholder" src="{{ asset('argon') }}/img/theme/bryan.jpg">
                    </span>
                </div>
            </a>
        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link" href="{{ route('home') }}">
                    <i class="ni ni-tv-2 text-primary"></i> {{ __('Clientes') }}
                </a>
            </li>
            <li class="nav-item">
